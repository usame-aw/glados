...
def generate_launch_description():
    return LaunchDescription([
        ...
        # Reference point is base downwards(not middle) 
        Node(
             package='tf2_ros',
             executable='static_transform_publisher',
             arguments = ['--x', '0.0', '--y', '-0.095', '--z', '0.0015', 
                          '--yaw', '0.0', '--pitch', '0.0', '--roll', '0.0', 
                          '--frame-id', 'base_link', '--child-frame-id', 'right_wheel_link']
        ),
        ...
        Node(
             ...
             arguments = ['--x', '0.0', '--y', '0.095', '--z', '0.0015', 
                          '--yaw', '0.0', '--pitch', '0.0', '--roll', '0.0', 
                          '--frame-id', 'base_link', '--child-frame-id', 'left_wheel_link']
        ),
